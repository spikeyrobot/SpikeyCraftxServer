...
public class XServer extends JavaPlugin
{
	...
	public void onEnable()
	{
		...
		formats.put("COMMAND", getConfig().getString("formats.Command"));
		...
		override.put("COMMAND", getConfig().getString("override.Command"));
	...
	private void setupPermissions()
	{
		...
		// FORCE DISABLING VAULT PERMISSIONS
		log.info("IGNORING PREVIOUS VAULT PERMISSIONS TEST");
		log.info("Using Bukkit Perms (Superperms)");
		permsMode = 2;
	}
